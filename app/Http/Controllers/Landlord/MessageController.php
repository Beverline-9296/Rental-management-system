...
class MessageController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('landlord.messages.index', compact('messages', 'stats'));
    }
    ...
    public function create(Request $request): View
    {
        ...
        $tenants = User::whereHas('tenantAssignments', function($query) use ($user) {
            $query->whereHas('unit.property', function($subQuery) use ($user) {
                $subQuery->where('landlord_id', $user->id);
            });
        })->get();
        ...
        return view('landlord.messages.create', compact('tenants', 'properties', 'recipient'));
    }
