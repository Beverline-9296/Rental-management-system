<footer class="bg-gray-800 border-t text-white">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Rental</h3>
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
            <p class="text-center text-sm text-gray-500">&copy; {{ date('Y') }} Rental. All rights reserved.</p>
        </div>
    </div>
</footer>
